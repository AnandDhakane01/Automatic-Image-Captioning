...
# caption_path = 'archive/Flickr_TextData/data.txt'
...
model = Model(inputs=conca, outputs = out)
...
model.save('./img_caption_model_v2.h5')


model.save_weights('./img_caption_model_v2_weights.h5')

np.save('./img_caption_model_v2_vocab.npy', new_dict)
